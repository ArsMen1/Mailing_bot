...
ok_keyboard = [[InlineKeyboardButton(ok_message(), callback_data=GET_MAIN_MENU_INDICATORS)]]
prev_keyboard = [[InlineKeyboardButton("Предыдущий", callback_data=None)],
                 [InlineKeyboardButton(ok_message(), callback_data=GET_MAIN_MENU_INDICATORS)]
                 ]  # todo: fill callback
next_keyboard = [[InlineKeyboardButton("Следующий", callback_data=None)],
                 [InlineKeyboardButton(ok_message(), callback_data=GET_MAIN_MENU_INDICATORS)]
                 ]  # todo: fill callback
double_keyboard = [[InlineKeyboardButton("Предыдущий", callback_data=None),
                    InlineKeyboardButton("Следующий", callback_data=None)],
                   [InlineKeyboardButton(ok_message(), callback_data=GET_MAIN_MENU_INDICATORS)]
                   ]  # todo: fill callbacks
